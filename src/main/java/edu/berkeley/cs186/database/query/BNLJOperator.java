...
public class BNLJOperator extends JoinOperator {
  ...
  public int estimateIOCost() throws QueryPlanException {
    /* TODO: Implement me! */
    /*int left = getLeftSource().getStats().getNumPages();
    int right = getRightSource().getStats().getNumPages();
    int buff;
    if (left < numBuffers) buff = left - 2;
    else buff = numBuffers - 2;
    if (buff < 1) buff = 1;
    return left + left * right / buff;*/
